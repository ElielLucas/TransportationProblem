    ...
    def criar_instancia(self, nome_instancia, iteracao, qtd_origens, qtd_trans, qtd_port, qtd_cli):
        ...
        for i in self.N:
            for k in self.K:
                ...
                velocidade_media = random.uniform(40, random.choice([50, 60, 80]))
        ...
        for k in self.K:
            for j in self.M:
                ...
                tempo = self.tempo_matrix[j, k] = self.dist_trans_porto[k, j] / random.uniform(130, 170)
        ...
        for i in self.N:
            for j in self.M:
                ...
                velocidade_media = velocidade_media = random.uniform(40, random.choice([50, 60, 80]))
